...
import invertedcoma from "../assets/invertedcoma.svg";
  ...
  return (
    <div className="sm:px-32 sm:py-24 bg-lightYellow flex justify-between items-center sm375:px-4 sm375:py-14">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-center sm:text-xl pt-4 text-fade font-normal sm:w-3/4 sm375:text-base font-dmSans">
        ...
        <p className="pt-6 text-base text-baseText font-medium font-dmSans">Zeal and Gaurav</p>
